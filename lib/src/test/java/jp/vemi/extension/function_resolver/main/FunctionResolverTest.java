...
public class FunctionResolverTest {
    ...
    private static String sentence1 =
        "${_abc()}abc ${_useraddr(U11110)}efefefe${alreadyObject}aa ${_abc()}, ${_def(abc,def,aaa)} abc";
    // private static String sentence1 =
    //     "${_abc()}abc ${_useraddr(U11110)}efef\nefefe${alreadyObject}aa ${_abc()}, ${_def(abc,def,aaa)} abc";
